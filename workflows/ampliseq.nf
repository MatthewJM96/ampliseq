...
if (params.qiime_ref_taxonomy && !params.skip_taxonomy && (!params.classifier || params.blast_consensus_taxonomy)) {
...
workflow AMPLISEQ {
    ...
    if ( run_qiime2 ) {
        ...
        if ( params.skip_taxonomy ) {
            ...
            val_used_taxonomy = "QIIME2 Consensus Blast"
        ...
        if (!params.skip_abundance_tables) {
            QIIME2_EXPORT ( ch_asv, ch_seq, ch_tax, ch_qiime2_tax, ch_dada2_tax, ch_pplace_tax, ch_sintax_tax, ch_blast_consensus_tax, tax_agglom_min, tax_agglom_max )
        }
